...
namespace Proxies\__CG__\path1\GesUsersBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ManageUsers extends \path1\GesUsersBundle\Entity\ManageUsers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'path1\\GesUsersBundle\\Entity\\ManageUsers' . "\0" . 'id', '' . "\0" . 'path1\\GesUsersBundle\\Entity\\ManageUsers' . "\0" . 'name', '' . "\0" . 'path1\\GesUsersBundle\\Entity\\ManageUsers' . "\0" . 'nationality', '' . "\0" . 'path1\\GesUsersBundle\\Entity\\ManageUsers' . "\0" . 'age', '' . "\0" . 'path1\\GesUsersBundle\\Entity\\ManageUsers' . "\0" . 'gender');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ManageUsers $proxy) {
