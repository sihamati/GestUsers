...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/UpdateUser') && preg_match('#^/UpdateUser/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => '_update_user')), array (  '_controller' => 'path1\\GesUsersBundle\\Controller\\ManageUsersController::UpdateUserAction',));
        }

        // _delete_user
        if (0 === strpos($pathinfo, '/DeleteUser') && preg_match('#^/DeleteUser/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => '_delete_user')), array (  '_controller' => 'path1\\GesUsersBundle\\Controller\\ManageUsersController::DeleteUserAction',));
        }

        // _list_user
        if ($pathinfo === '/ListUsers') {
            return array (  '_controller' => 'path1\\GesUsersBundle\\Controller\\ManageUsersController::ListUserAction',  '_route' => '_list_user',);
        }
